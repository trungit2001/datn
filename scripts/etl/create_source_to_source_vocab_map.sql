...
select * into cdm_schema.source_to_source_vocab_map 
from cte_vocab_map;

create index idx_source_vocab_map_source_code 
	on cdm_schema.source_to_source_vocab_map (source_code);

create index idx_source_vocab_map_source_vocab_id 
	on cdm_schema.source_to_source_vocab_map (source_vocabulary_id);
